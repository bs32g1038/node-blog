                ...
                render: (text, record) => (
                    <div>
                        <Button
                            ...
                            size="small"
                            title="编辑"
                            onClick={() => this.props.history.push('/blog/admin/categories/edit/' + record._id)}>
        ...
        return (
            <div className="main-content">
                <div className="manager-tip">
                    <i className="fa fa-edit fa-fw"></i><strong>控制台----分类管理</strong>
                </div>
                <div className="panel">
                    <Button
                        type="primary"
                        onClick={() => this.props.history.push('/blog/admin/categories/edit')}>
