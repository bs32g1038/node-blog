                ...
                render: (text, record) => (
                    <div>
                        <Button
                            ...
                            size="small"
                            title="编辑"
                            onClick={() => this.props.history.push('/blog/admin/comments/reply/' + record._id)}>
                            <i className="fa fa-edit fa-fw"></i>
                            回复
                        </Button>,
                        <Popconfirm title="确认要删除？" onConfirm={() => this.deleteComment(record._id)} okText="确定" cancelText="取消">
                            <Button
                                type="danger"
                                size="small"
                                title="删除">
        ...
        return (
            <div className="main-content">
                <div className="manager-tip">
                    <i className="fa fa-edit fa-fw"></i><strong>控制台----评论管理</strong>
                </div>
                <div className="panel">
                    <Button
                        type="danger">
