        ...
        <li key={item.name} className="pinned-item-list-item">
            <div className="pinned-item-list-item-content">
                <div className="header">
                    ...
                    <a href={siteInfo.github + '/' + item.name} rel="noopener noreferrer" target="_blank">
                        {item.name}
                    </a>
                ...
                <p className="meta">
                    ...
                    <a
                        className="pinned-item-meta"
                        href={siteInfo.github + '/' + item.name + '/stargazers'}
                    ...
                    <a
                        className="pinned-item-meta"
                        href={siteInfo.github + '/' + item.name + '/network/members'}
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        <svg
