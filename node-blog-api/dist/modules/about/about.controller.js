...
let AboutController = class AboutController {
    ...
    getUserData(query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.aboutService.getUserData(query.username);
        });
    }
};
__decorate([
...
], AboutController.prototype, "getUserData", null);
AboutController = __decorate([
    common_1.Controller('/api/about/github/user-profile/:username'),
