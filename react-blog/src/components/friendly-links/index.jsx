            ...
            <DocumentTitle title="友情链接">
                <div className="FriendlyLinks">
                    ...
                    <footer className="FriendlyLinks-footer">
                        <h3 className="FriendlyLinks-tip"><i className="fa fa-info-circle fa-fw"></i>链接须知</h3>
                        <ol>
                        ...
                        <p>要申请友链的小伙伴们，请到博客<Link to="/blog/guestbook" className="FriendlyLinks-jump">留言版</Link>进行留言，我将会在收到的第一时间进行添加，谢谢！</p>
                    </footer>
                </div>
            </DocumentTitle>
        );
