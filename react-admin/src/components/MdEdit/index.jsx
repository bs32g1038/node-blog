        ...
        return (
            <div className="MdEditor">
                <div className="MdEditor-toolbar">
                    ...
                    <div style={{ flex: '1 0 auto', textAlign: 'center' }}><strong>markdown编辑器，开始写作吧！</strong></div>
                ...
                <div className="MdEditor-wraper">
                    ...
                    {
                        this.state.isPreview && <div className="preview markdown-body" dangerouslySetInnerHTML={{
