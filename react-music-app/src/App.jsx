...
export default class App extends React.Component {
     ...
     */
    ajaxGetLyric(id) {
        const lrc = musicLyric[id] || '';
        let data = this.parseLyric(lrc);
        let lyric = {};
        let i = -1;
        for (let k in data) {
            lyric[k] = {
            ...
            <div className="music-wrap">
                ...
                <header className="header">
                    ...
                    <div className="header-help">
                        <button onClick={() => this.showAboutDialog()}>关于</button>
                    </div>
                </header>
                <div className="MusicCore">
                    ...
                    <div className="MusicCore-footer">
                        <div className="MusicPlayArea">
                            <button title="上一曲" className="prev" onClick={() => this.playPre()}>
                            ...
                            {
                                this.state.isPaused ?
                                    <button title="播放" className="pause" onClick={() => this.play()}>
                                    ...
                                    :
                                    <button title="暂停" className="play" onClick={() => this.pause()}>
                                        <svg className="icon-play" viewBox="0 0 1024 1024">
                            ...
                            <button title="下一曲" className="next" onClick={() => this.playNext()}>
                            ...
                            </div>
                            {
                                this.state.playMode === 0 ?
                                    <button title="列表循环" className="recycle" onClick={() => this.setMode(1)}>
                                    ...
                                    :
                                    <button title="列表随机" className="recycle" onClick={() => this.setMode(0)}>
                                        <svg className="icon-recycle" viewBox="0 0 1024 1024">
                            ...
                            <button title="下载" className="down">
